...
s11_db_2 = reseau_2.s_db[:, 0, 0]

ax.plot(freq_ghz_1, s11_db_1, linewidth=1.8, label="Model 1")
ax.plot(freq_ghz_2, s11_db_2, linewidth=1.8, label="Model 2")
...
plt.tight_layout()
plt.savefig("S11_compare.png", dpi=150)
plt.show()