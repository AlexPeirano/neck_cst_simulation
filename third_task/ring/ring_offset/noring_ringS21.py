...
s11_offset = reseau_offset.s_db[:, 1, 0]
ax.plot(
	freq_offset,
	s11_offset,
	linewidth=3.0,
...
ax.set_title('S21 Comparison: no ring vs ring', fontsize=14)
ax.grid(True, alpha=0.35)
ax.set_xlim(freq_min, freq_max)
ax.legend(fontsize=9, loc='lower left')

plt.tight_layout()
plt.savefig("S21_ring_noring.png", dpi=150)
plt.show()