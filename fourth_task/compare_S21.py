...
files = {
    "(fat, muscle)*1.5": Path("ring_15_propre/ring_topology_15.s2p"),
    "(fat, muscle)*2.0": Path("ring_2_propre/ring_topology_20.s2p"),
    "obese": Path("obese/ring_topology_real_obse.s2p")
}
...
ax.set_title('S21 Comparison: (fat, muscle)*1.5, *2.0 and obese', fontsize=14)
...
plt.tight_layout()
plt.savefig("S21_comparison_all.png", dpi=150)
print("Graphique S21 sauvegardé dans S21_comparison_all.png")
