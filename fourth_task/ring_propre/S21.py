...
if not fichiers:
    ...
    plt.tight_layout()
    plt.savefig(dossier / "S21_compare_all.png", dpi=150)
    print(f"Graphique S21 sauvegardé dans {dossier / 'S21_compare_all.png'}")
