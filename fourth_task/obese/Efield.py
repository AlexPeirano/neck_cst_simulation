...
if not files:
    ...
    for fname in files:
        ...
        # Z[24] is used in other scripts as a reference point for the antenna center.
        # I should verify if Z[24] is still the correct reference for this mesh.
        # In init_model_propre/Efield.py it was Z[24].
