...
fichiers = sorted(dossier.glob("model_15_time_*.s2p"), key=extract_tcoupling)
...
ax.set_title('S11 Parameter Sweep', fontsize=14)
...
plt.tight_layout()
plt.savefig("S11_sweep_G15.png", dpi=150)
plt.show()